...
class Tres extends StatefulWidget {
  @override
  _Tres createState() => _Tres();
}


class _Tres extends State<Tres> {
  @override
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage('assets/metronome.png'),
              fit: BoxFit.contain
          )
      ),
      child: Scaffold(
...
class WandCoords {
  ...
  WandCoords(double width, double height, int tempo, int minTempo, int maxTempo) {
    ...
    counterWeightCenter = new Offset(0, height*0.0005);
    counterWeightRadius = width/12;

    stickTop = new Offset(0, - height * 0.68);
    stickBottom = new Offset(0, height * 0.0005);
...
class MetronomeWandPainter extends CustomPainter{
  ...
  Color _bobTextColor= Colors.black;
